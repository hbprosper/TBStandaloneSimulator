...
//#include "HGCal/TBStandaloneSimulator/interface/HGCSSRecoJet.hh"
#include "HGCal/TBStandaloneSimulator/interface/HGCSSCalibration.hh"
#include "HGCal/TBStandaloneSimulator/interface/HGCSSDigitisation.hh"
#include "HGCal/TBStandaloneSimulator/interface/HGCSSDetector.hh"
...
int main(int argc, char** argv){//main  
  ...
  if (nPar < nReqA-1) {
    std::cout << " Usage: "
	      ...
	      << "<Number of si layers for TB setups>" << std::endl
              ...
              << "<optional: save digi hits (default=1)> " << std::endl
  ...
  unsigned debug = 0;
  unsigned pSeed = 0;
  bool pSaveDigis = true;
  bool pSaveSims = false;
