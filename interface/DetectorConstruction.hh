...
public:
  ...
  int getModel()   { return m_geometry.model(); }
  int getVersion() { return m_geometry.version(); }
  ...
  G4double GetCellSize()    { return m_CellSize; }
  ...
  bool saveTracks(){ return m_config.savetracks; }
